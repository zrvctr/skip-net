...
msg21=This functionality presupposes Java Runtume starting from version 1.5\nAt present used Java run time has version:
...
tooltip34=Skip-Net start and register it in Internet
item35=Start Skip-Net server
tooltip35=Begin the Skip-Net game and wait on others players (with manual connection establishment)
hilfe=Help
Spielregeln=Rules
Info=Info
...
title71=Found Skip-Net servers
